...
function _manually_load_plugin() {
	if ( ! defined( 'WC_EMAIL_INQUIRY_TRAVIS' ) ) { 
		define( 'WC_EMAIL_INQUIRY_TRAVIS', true );
	}
	...
	echo esc_html( 'Loading WC Email Inquiry plugin' . PHP_EOL );
	require dirname( dirname( __FILE__ ) ) . '/woocommerce-email-inquiry-cart-options.php';
